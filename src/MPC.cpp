...
vector<double> MPC::Solve(Eigen::VectorXd state,
  ...
  // Create output vector and write in throttle and steering commands.
  vector<double> output = {solution.x[delta_start],
                           solution.x[a_start]};
  // Add the predicted trajectory to the output vector
  for (int i=0; i < N-1; ++i) {
